...
public class AppTest extends TestCase {
	...
	public void testApp() throws ParseException {
		...
		TicketChangesListDto ticketChangesList = (TicketChangesListDto) RESTServiceUtil.unmarshaller(TicketChangesListDto.class, ticketChangesXml);
