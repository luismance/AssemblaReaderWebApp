...
class SpaceList extends React.Component {
	...
	render() {
		...
		return ( <div><ul className="nav nav-tabs">{listItems}</ul> <TicketList spaceId={currentSpaceId} /> </div>);
	}
...
class TicketList extends React.Component {
	...
	render() {
		const listItems = this.state.tickets.map((ticket, i) => <li className="list-group-item d-flex justify-content-between align-items-center" key={ticket.id}>{ticket.name}<span className="badge badge-primary badge-pill">{ ticket.number }</span></li> );
